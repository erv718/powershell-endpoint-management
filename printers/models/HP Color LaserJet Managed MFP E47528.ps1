# Variables
$driverDownloadPath = '\\SYSADMIN01\Tools\Printers\Clubs\Back Office\HP Color LaserJet Managed MFP E47528\Driver'
...
$driverName = "HP Color LaserJet MFP E47528 PCL-6 (V4)" # Must be exact! Install driver on your computer and copy its name and paste here!
