# Variables
$driverDownloadPath = '\\SYSADMIN01\Tools\Printers\Clubs\Front Desk\HP LaserJet Pro 4001n\Driver'
...
$driverName = "HP LaserJet Pro 4001 4002 4003 4004 PCL-6 (V4)" # Must be exact! Install driver on your computer and copy its name and paste here!
