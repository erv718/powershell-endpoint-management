#BO Printer
# Variables
$driverDownloadPath = '\\SYSADMIN01\Tools\Printers\Clubs\Back Office\HP Color LaserJet Pro MFP M283fdw\Driver'
...
$driverName = "HP ColorLaserJet MFP M282-M285 PCL 6 (V3)" # Must be exact! Install driver on your computer and copy its name and paste here!
